...
class _MainFormPageState extends State<MainFormPage> {
  ...
  Widget linkWidget() {
    return Container(
      ...
      child: Text(
        'Beschreibung des Programms: http://fluttercrypto.bplaced.net/flutter-aes-playground',
        style: TextStyle(
          fontSize: 18,
          color: Colors.blue,
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Link(
                  ...
                  uri: Uri.parse('http://fluttercrypto.bplaced.net/flutter-aes-kryptographie/'),
