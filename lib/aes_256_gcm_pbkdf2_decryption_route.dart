...
class _MyFormPageState extends State<Aes256GcmPbkdf2DecryptionRoute> {
                              ...
                              if (_formKey.currentState!.validate()) {
                                ...
                                try {
                                  ...
                                  gcmTag = parsedJson['gcmTag'];
                                    ...
                                    outputController.text = 'Fehler: Die Eingabe sieht nicht nach einem Json-Datensatz aus.';
                                    return;
                                } on NoSuchMethodError catch (e) {
                                    outputController.text = 'Fehler: Die Eingabe ist ungültig.';
                                    return;
                                }
                                if (algorithm != 'AES-256 GCM PBKDF2') {
                                  outputController.text = 'Fehler: es handelt sich nicht um einen Datensatz, der mit AES-256 GCM PBKDF2 verschlüsselt worden ist.';
                                  return;
                                }

                                // rebuild string for aes gcm
                                String ciphertextComplete =
                                    salt + ':' + iv + ':' + ciphertext + ':' + gcmTag;

                                String decryptionText =
                                aesGcmIterPbkdf2DecryptFromBase64(
                                    password, iterationsString, ciphertextComplete);
  ...
  String aesGcmIterPbkdf2DecryptFromBase64(String password, String iterations, String data) {
    try {
